...
if (isset($_POST["btnSubmit"])) {
    ...
    if ($style != "Hand Tossed" AND $style != "Handmade Pan"){
        $errorMsg[] = "Please choose a pizza style.";
        $styleERROR = true;        
    }
...
<article id='main'>
    ...
    if (isset($_POST["btnSubmit"]) AND empty($errorMsg)) {
        ...
        print '<h1>Order Online</h1>';
        print '<p class="form-heading">Carry out orders will take 20-40 minutes. Deliveries may take 30-60 minutes depending on the current demand for pizza.</p>';
    ...
    <form action="<?php print $phpSelf; ?>"
            ...
            <fieldset id="pizzaOrder" class=" <?php if ($pizzaERROR) print ' mistake'; ?>">
                ...
                <p>
                    <select id="lstPizzaSize"
                        ...
                        <option <?php if($size=="Small") print " selected "; ?>
                            value="Small">Small (12-inch, +$1.50)</option>
                        
                        <option <?php if($size=="Individual") print " selected "; ?>
                            value="Individual">Individual (14-inch, +$2.50)</option>
                        
                        <option <?php if($size=="Large") print " selected "; ?>
                            value="Large">Large (16-inch, +$5.00)</option>
                        
                        <option <?php if($size=="X Large") print " selected "; ?>
                            value="X Large">X Large (18-inch, +$7.50)</option>
                    ...
                    <p>
                        <label class="radio-field">
                            <input type="radio"
                                   ...
                                   value="Hand Tossed"
                                   tabindex="13"
                                   <?php if ($style == 'Hand Tossed') echo ' checked="checked" '; ?>>
                            Hand Tossed</label>
                    </p>
                    ...
                    <p>
                        <label class="radio-field">
                            <input type="radio"
                                   ...
                                   value="Handmade Pan"
                                   tabindex="14"
                                   <?php if ($style == 'Handmade Pan') echo ' checked="checked" '; ?>>
                            Handmade Pan</label>
                    </p>
                </article>
                ...
                <ul class="columnsCheckBox noIndent">
                    <li class="noIndent">
